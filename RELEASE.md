...
This document outlines the steps to release a new version of the [otel-add-on](https://github.com/kedify/otel-add-on/pkgs/container/otel-add-on) container image and [otel-add-on](https://github.com/kedify/otel-add-on/pkgs/container/charts%2Fotel-add-on) helm chart.
